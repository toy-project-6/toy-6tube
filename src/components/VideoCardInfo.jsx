  ...
  return (
    <div className='flex gap-4'>
      ...
      <div className={related ? 'py-2 grid' :'grid gap-2'}>
        <p className={related ? 'w-30 overflow-hidden text-ellipsis text-white text-sm leading-5 line-clamp-1 h-5' : 'text-white line-clamp-2 leading-5 font-bold'}>{title}</p>
